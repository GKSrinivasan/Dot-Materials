...
// Component Name :   ICommunicationProcessManager
// Description    :   Interface signature for CommunicationProcessManager
...
{
    public interface ICommunicationProcessManager
    {
        // Author       : Shaheena Shaik
        //Creation Date : 18/April-2017
        /// <summary>
        ...
        List<AppEmailDetails> GetAppEmailInfo();
        ...
        string PutCommunicationEmail(string ddlSubject, string editor, int appMailID, int userNum);
        ...
        List<AppMessageModel> GetDashboardMessage(int? messageId);
        ...
        List<EmailDetails> EmailConfiguration(List<EmailDetails> emailInfoList, int templateID, AppConfigModel appConfigModel, int userNum, string requestUR);
